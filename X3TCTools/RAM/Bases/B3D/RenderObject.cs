...
namespace X3Tools.RAM.Bases.B3D
{
    public class RenderObject : MemoryObject, INumericIDObject
    {
        ...
        public override void SetData(byte[] Memory)
        {
            ...
            ParentRelativePosition = collection.PopIMemoryObject<Vector3_32>();
            ...
            ModelScale = collection.PopIMemoryObject<Vector3_32>();
            ...
            AbsolutePosition = collection.PopIMemoryObject<Vector3_32>();
            ...
            LightAttenuation = collection.PopIMemoryObject<Vector3_32>();
            ...
            Saturation = collection.PopIMemoryObject<Vector3_32>();
